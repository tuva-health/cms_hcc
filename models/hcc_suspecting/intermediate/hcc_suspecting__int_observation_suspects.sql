...
, bmi_over_30_with_osa as (
    ...
    from numeric_observations
        ...
        inner join obstructive_sleep_apnea
            ...
            and {{ the_tuva_project.date_part('year', 'numeric_observations.observation_date') }} = {{ the_tuva_project.date_part('year', 'obstructive_sleep_apnea.recorded_date') }}
...
, bmi_over_35_with_diabetes as (
    ...
    from numeric_observations
        ...
        inner join diabetes
            ...
            /* ensure bmi and condition overlaps in the same year */
            and {{ the_tuva_project.date_part('year', 'numeric_observations.observation_date') }} = {{ the_tuva_project.date_part('year', 'diabetes.recorded_date') }}
        inner join seed_hcc_descriptions
            on seed_hcc_descriptions.hcc_code = '48'
    where LOWER(seed_clinical_concepts.concept_name) = 'bmi'
        and result >= 35
...
, bmi_over_35_with_hypertension as (
    ...
    from numeric_observations
        ...
        inner join hypertension
            ...
            /* ensure bmi and condition overlaps in the same year */
            and {{ the_tuva_project.date_part('year', 'numeric_observations.observation_date') }} = {{ the_tuva_project.date_part('year', 'hypertension.recorded_date') }}
        inner join seed_hcc_descriptions
            on seed_hcc_descriptions.hcc_code = '48'
    where LOWER(seed_clinical_concepts.concept_name) = 'bmi'
        and result >= 35
...
, hcc_48_suspect as (
    ...
    select
        ...
        , {{ the_tuva_project.concat_custom([
            ...
            " else " ~
            the_tuva_project.concat_custom(["' with '",
                        "condition_concept_name",
                        "'('",
                        "condition_code",
                        "' on '",
